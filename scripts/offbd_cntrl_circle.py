...
class Controller:
    ...
    def updateSp(self):
        ...
        self.sp.position.x = 2*np.cos(2*np.pi*(0.005)*self.t) 
        self.sp.position.y = 2*np.sin(2*np.pi*(0.005)*self.t)
        print "t", self.t, "x", self.sp.position.x, "y", self.sp.position.y
        print "x_calc", 2*np.cos(2*np.pi*(0.005)*self.t), "y_calc", 2*np.sin(2*np.pi*(0.005)*self.t)
